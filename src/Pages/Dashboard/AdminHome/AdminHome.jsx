    ...
    return (
        <div>
           <h2 className=" text-3xl">
            ...
            <div className="stats shadown w-full">
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaDollarSign className=' text-3xl'> </FaDollarSign>
                </div>
                <div className="stat-title">Revinue</div>
                <div className="stat-value">$ {starts?.revenue} </div>
            ...
            <div className="stat">
                ...
                <div className="stat-value">{starts?.users}</div>
            ...
            <div className="stat">
                ...
                <div className="stat-value">{starts?.menuItems}</div>
                <div className="stat-desc">↗︎ 400 (22%)</div>
            </div>
            ...
            <div className="stat">
                ...
                <div className="stat-value">{starts?.orders}</div>
